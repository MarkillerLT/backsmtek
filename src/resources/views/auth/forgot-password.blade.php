...
{{--Nav Bar--}}
    ...
    {{-- ╔══════════════════════════════════════════════════════════╗
         ║  HERO — recuperar contraseña                            ║
         ╚══════════════════════════════════════════════════════════╝ --}}
    <div class="hero recuperar-hero">
        <div class="hero-content">

            {{-- ── Layout: intro + card formulario ── --}}
            <div class="recuperar-layout">

                {{-- Columna izquierda: texto descriptivo --}}
                <div class="cotiz-intro">
                    <div class="cotiz-badge">Recuperar acceso</div>
                    <h1 class="cotiz-titulo">¿Olvidaste tu <span>contraseña</span>?</h1>
                    <p class="cotiz-desc">
                        No hay problema. Indícanos tu correo y te enviaremos un enlace
                        para que elijas una contraseña nueva y recuperes el acceso a tu cuenta.
                    </p>


                {{-- Columna derecha: formulario --}}
                <div class="register-card cotiz-card recuperar-card">
                    ...
                    @session('status')
                        <div class="cotiz-alert-wrap" style="margin-bottom: 2rem;">
                    ...
                    <x-validation-errors class="register-error-block" />

                    <form method="POST" action="{{ route('password.email') }}" novalidate>
                        @csrf

                        <div class="register-field">
                            <label for="email">Correo electrónico <span class="cotiz-req">*</span></label>
                            <input
                                id="email"
                                type="email"
                                name="email"
...
>
    ...
    <style>
        ...
        /* ── Columna izquierda: texto (reutiliza estilos de cotiz-intro) ── */
        .cotiz-intro {
            display: flex;
            flex-direction: column;
            gap: 2rem;
        ...
        /* ── Errores de validación (paquete de Jetstream) ── */
        .register-error-block ul {
            list-style: none;
            margin: 0 0 1.8rem;
            padding: 0;
            display: flex;
        ...
        #login.hero,
        .hero.recuperar-hero {
          background-image: url({{ asset('assets/img/heros/recuperar.jpg') }});
        }
    </style>
