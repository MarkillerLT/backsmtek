...
{{--
|--------------------------------------------------------------------------
| Vista: admin/usuarios/index.blade.php — Usuarios SMTEK
...
--}}
    <style>
        ...
        body.dark-mode .estado-badge.usuario { background-color: rgba(33,150,186,0.18); color: var(--AzulSmtek); }
        body.dark-mode .estado-badge.admin   { background-color: rgba(29,158,117,0.2);  color: #2ecc9a; }

        /* ── Texto muted (usuario actual) ── */
        .text-muted-inline {
            font-size: 1.3rem;
            color: var(--text-muted);
            font-style: italic;
                            ...
                            <tr>
                                ...
                                <td>
                                    @if ($usuario->rol === 'admin')
                                        <span class="estado-badge admin">Administrador</span>
                                    @else
                                        <span class="estado-badge usuario">Usuario</span>
                                    @endif
                                </td>
                                <td>
                                    @if ($usuario->id === auth()->id())
                                        <span class="text-muted-inline">Usuario actual</span>
